    ...
    <div className="min-h-screen bg-black text-white max-w-2xl mx-auto px-4 md:px-0 font-sans space-y-6 text-base leading-relaxed">
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <li>
            I embrace **Server Components** as the default data-fetching layer. It helps avoid hydration cost and reduces bundle size.
          </li>
          <li>
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <li>
            File conventions like `.web.tsx` / `.native.tsx` for cross-platform logic.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
          <li>State: `let` over `const` — prepare for future transitions.</li>
